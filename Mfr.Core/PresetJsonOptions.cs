        ...
        private static void _ConfigureBaseFilterPolymorphism(JsonTypeInfo typeInfo)
        {
            ...
            typeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(TokenMoverFilter), "TokenMover"),
                    new JsonDerivedType(typeof(NameListFilter), "NameList"),
                    ...
                    new JsonDerivedType(typeof(SentenceEndCharactersFilter), "SentenceEndCharacters"),

...
Click the **Select Fields** toolbar button on the Rename List, or right-click the grid and choose **Select Fields...**, to open the field shuttle (visible columns and Auto-Sort tabs).

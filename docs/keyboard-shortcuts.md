...
Undo and Log appear in the menu and toolbar now; those commands are still stubs. Options (Ctrl+,) is live. GO previews the current list, warns before ignoring preview errors, and then applies valid renames.

...
**Status (2026-09-05):** F5 Time Shifter done. **Next: F5 Attributes Setter**. Rename List Phase 10–11 already consume `ToChain()` → live preview when Auto-Preview is on.
...
- **20 (next)** — Attributes Setter (Attributes) — attribute flags

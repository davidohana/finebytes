...
**Status (2026-09-05):** F5 Audio Tag Remover + Audio Tag Setter done. **Next: F5 ID3v2 Field Setter**. Rename List Phase 10–11 already consume `ToChain()` → live preview when Auto-Preview is on.
...
- **23 (next)** — ID3v2 Field Setter (Audio) — frame + value

...
- **Style:** Keep [`help/help.css`](help/help.css) chrome (Verdana, brand bar, breadcrumb, `.quote` `#b00b0b`, CODE examples). Pages are **end-user** copy describing today’s product — not `Mfr.Filters/docs` developer notes; strip “screenshot optional / capture to…” meta from shipped prose where practical (screenshots remain optional assets; recapture with `just capture-help`, see [`CONTRIBUTING.md`](../../CONTRIBUTING.md)).

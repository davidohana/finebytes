...
namespace Mfr.Tests.Ui.AppliedFilters
{
    ...
    public sealed class FilterEditorViewModelTests
    {
        ...
        {
            var editor = new FilterEditorViewModel();
            var step = new AppliedFilterStepViewModel("Shrink Spaces", new Filters.Space.ShrinkSpacesFilter());
        ...
        {
            var editor = new FilterEditorViewModel();
            var first = new AppliedFilterStepViewModel("Shrink Spaces", new Filters.Space.ShrinkSpacesFilter());

...
namespace Mfr.Tests.Ui.FilterEditors
{
    ...
    public sealed class FilterEditorViewTests
    {
        ...
        /// </summary>
        [AvaloniaFact]
        public async Task Mover_root_folder_drop_folder_sets_path()
        {
            ...
            try
            {
                ...
                var dataTransfer = await RenameList.RenameListTestHelpers.CreateFileDataTransferAsync(window, [dest]);
        ...
        /// </summary>
        [AvaloniaFact]
        public async Task Mover_root_folder_drop_file_uses_parent()
        {
            ...
            try
            {
                ...
                var dataTransfer = await RenameList.RenameListTestHelpers.CreateFileDataTransferAsync(
                    window,
                    [filePath]
                );
                dropTarget.RaiseEvent(
        ...
        /// </summary>
        [AvaloniaFact]
        public void Mover_root_folder_drag_over_rejects_non_file()
        {
            var (window, mainViewModel, editorView) = _ShowFilterEditorPanes();
            mainViewModel.AppliedFiltersViewModel.AppendCommand.Execute(AppliedFiltersTestUi.Entry("Mover"));
            window.UpdateLayout();

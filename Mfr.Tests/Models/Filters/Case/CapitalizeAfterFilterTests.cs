...
namespace Mfr.Tests.Models.Filters.Case
{
    public class CapitalizeAfterFilterTests
    {
        ...
        {
            var filter = new CapitalizeAfterFilter(true, _target, new CapitalizeAfterOptions());
        ...
        {
            var filter = new CapitalizeAfterFilter(true, _target, new CapitalizeAfterOptions("._"));

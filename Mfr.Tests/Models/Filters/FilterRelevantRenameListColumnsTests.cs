...
namespace Mfr.Tests.Models.Filters
{
    ...
    public sealed class FilterRelevantRenameListColumnsTests
    {
        ...
        [InlineData("<geo-place>", JpegRenameListFields.Group, JpegRenameListFields.Key.NearbyPlace)]
        [InlineData("<geo-region>", JpegRenameListFields.Group, JpegRenameListFields.Key.NearbyRegion)]
        [InlineData("<geo-country>", JpegRenameListFields.Group, JpegRenameListFields.Key.NearbyCountry)]

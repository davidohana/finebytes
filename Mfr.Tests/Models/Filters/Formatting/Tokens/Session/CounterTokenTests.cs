...
namespace Mfr.Tests.Models.Filters.Formatting.Tokens.Session
{
    ...
    {
        private const string _defaultsEquivalent = "initial=1,step=1,padding=none,length=2,resetScope=global";
        ...
        public void Resolve_PositionalStyleArgs_Throws()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(() => token.Compile(tokenArgs: "1,2")(item));

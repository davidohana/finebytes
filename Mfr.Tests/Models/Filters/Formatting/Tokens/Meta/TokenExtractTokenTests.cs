    ...
    public sealed class TokenExtractTokenTests
    {
        ...
        public void Resolve_Token1_SingleCharSeparator_ReturnsFirstPart()
        {
            var item = FilterTestHelpers.CreateRenameItem(
                fileName: "13_-_Smog_-_Cold_Blooded_Old_Times",
                extension: "mp3"
            );
            Assert.Equal(
                "13_",
        ...
        {
            var item = FilterTestHelpers.CreateRenameItem(fileName: "a_b_c", extension: "txt");
        ...
        public void ResolveTemplate_Token2MultiSepIncludeNext_ExtractsRemainder()
        {
            ...
            Assert.Equal("Smog_-_Cold_Blooded_Old_Times.mp3", compiled(item));
        }
        ...
        {
            var item = FilterTestHelpers.CreateRenameItem(fileName: "a_b", extension: "txt");

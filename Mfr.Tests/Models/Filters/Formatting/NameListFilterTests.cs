...
namespace Mfr.Tests.Models.Filters.Formatting
{
    ...
    public sealed class NameListFilterTests
    {
        ...
        public void Apply_MapsLineIndexToGlobalIndex()
        {
            ...
            Assert.Equal("Alpha", FilterTestHelpers.ApplyToFileName(f, "old0", renameListIndex: 0));
            Assert.Equal("Beta", FilterTestHelpers.ApplyToFileName(f, "old1", renameListIndex: 1));
            Assert.Equal("Gamma", FilterTestHelpers.ApplyToFileName(f, "old2", renameListIndex: 2));
        }
        ...
        public void Apply_PrefixSuffixAndCounterToken()
        {
            ...
            Assert.Equal("10_One_end", FilterTestHelpers.ApplyToFileName(f, "x", renameListIndex: 0));
        }
        ...
        public void Apply_BlankLines_AreEntries()
        {
            ...
            Assert.Equal("First", FilterTestHelpers.ApplyToFileName(f, "a", renameListIndex: 0));
            Assert.Equal(string.Empty, FilterTestHelpers.ApplyToFileName(f, "b", renameListIndex: 1));
            Assert.Equal("Second", FilterTestHelpers.ApplyToFileName(f, "c", renameListIndex: 2));
        }
        ...
        {
            var f = _CreateFilter([]);
            Assert.Equal("old", FilterTestHelpers.ApplyToFileName(f, "old", renameListIndex: 0));
        }
        ...
        public void Apply_TooFewLines_ThrowsUserException()
        {
            ...
            var ex = Assert.Throws<UserException>(() =>
                FilterTestHelpers.ApplyToFileName(f, "old", renameListIndex: 1)
            );
            Assert.Equal(
        ...
        public void JsonDeserialize_SamplePreset_EntriesArray()
        {
            ...
            Assert.Equal("Beta", FilterTestHelpers.ApplyToFileName(typed, "old1", renameListIndex: 1));
        }
        ...
        public void JsonDeserialize_MissingEntries_IsEmptyNoOp()
        {
            ...
            Assert.Equal("old", FilterTestHelpers.ApplyToFileName(typed, "old", renameListIndex: 0));
        }
        ...
        public void JsonDeserialize_NullPrefixSuffix_CoerceToEmpty()
        {
            ...
            Assert.Equal("Only", FilterTestHelpers.ApplyToFileName(typed, "old", renameListIndex: 0));
        }

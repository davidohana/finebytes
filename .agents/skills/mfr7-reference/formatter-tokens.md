...
1. Open matching `Help/Images/*fp.gif` for the format editor UI.
1. Read `*FormattingParameter.cs` for parse rules, defaults, and edge cases.
1. Read finebytes `*Token.cs` and `*TokenTests.cs` for current parity and tests citing MFR7.

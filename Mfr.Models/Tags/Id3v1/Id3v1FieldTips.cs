namespace Mfr.Models.Tags.Id3v1
{
    ...
    public static class Id3v1FieldTips
    {
        ...
        public static string For(Id3v1Field field)
        {
            return field switch
            {
                Id3v1Field.Title => "Track title in the ID3v1 tag (only about 30 characters fit on disk).",
                Id3v1Field.Artist => "Artist name in the ID3v1 tag (only about 30 characters fit on disk).",
                Id3v1Field.Album => "Album title in the ID3v1 tag (only about 30 characters fit on disk).",
                Id3v1Field.Year => "Four-digit year in the ID3v1 tag.",
                Id3v1Field.Comment => "Comment in the ID3v1 tag (only about 28 characters fit on disk).",

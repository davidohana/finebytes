...
namespace Mfr.Models.RenameList
{
    ...
    /// <para>
    /// Also the <c>session.json</c> <c>sortFields</c> element shape (<c>key</c> / <c>descending</c>).
    /// </para>
    /// </summary>
    ...
    public readonly record struct RenameListSortKey(
        [property: JsonPropertyName("key")] RenameListFieldKey FieldKey,

namespace Mfr.Filters.Formatting
{
    ...
    {
        /// <summary>
        /// Creates a filter with MFR7 add-to-list defaults (file name, hyphen delimiter, first token +1).
        /// </summary>
        public TokenMoverFilter()
            : this(new FileNameTarget(), new TokenMoverOptions(Delimiter: "-", TokenNumber: 1, MoveBy: 1)) { }

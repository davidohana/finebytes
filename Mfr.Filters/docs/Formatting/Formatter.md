...
| Token                          | Output                                                                                                                                                                                                                                                                                  |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<file-date:format,date-kind>` | Arguments are **required**. **Both** parts: a .NET date format string, then a comma, then `date-kind`. Split uses the **last** comma so `format` may contain commas. `date-kind` (case-insensitive): `creation`, `lastWrite`, `lastAccess`. Example: `<file-date:yyyy-MM-dd,creation>`. |
| `<drive-letter>`               | Drive letter of the file's location (e.g. `C`, no trailing colon). Returns `$` for network (UNC) paths.                                                                                                                                                                                 |
...
| Token                                                        | Output                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<now>`                                                      | Current UTC time as `yyyy-MM-dd_HH-mm-ss`.                                                                                                                                                                                                                                                                                                                                    |
...
Unknown token names fail when the filter is set up (compile / preview), not left as literals. Token **names** are matched exactly (no surrounding whitespace): `<file-name >` and `< file-name>` are unknown, not aliases of `<file-name>`. Named **arguments** still allow optional spaces around `,` and `=` (see counter / substr / token rows above). For embedded name lists, use the [NameList](NameList.md) filter (there is no `<name-list-entry>` token).

...
- **`capitalizeAfterChars`** (string, default `",!()[]{};-"`)
  - Every character in this string is a trigger: the **next** character in the segment is uppercased (default includes
    comma, `!`, parentheses, brackets, `;`, `-`).

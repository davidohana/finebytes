...
namespace Mfr.Filters.Case
{
    ...
    )
    {
        ...
        /// </summary>
        /// <remarks>
        /// Same array as the title-case exception segment of <see cref="CasingListOptions.DefaultWords"/>
        /// (articles, short conjunctions, common prepositions, and short <c>be</c> forms).
        /// </remarks>
        public static IReadOnlyList<string> DefaultCapitalizeSkipWords { get; } = CommonCasingWords.TitleCaseExceptions;
    }
    ...
    [FilterPalette(FilterGroup.Case, "Letters Case")]

...
namespace Mfr.App.Ui.Views.FormatEditor
{
    ...
    /// <para>
    /// <c>Mfr.App.Ui.ViewModels.FormatEditor.TokenEditors[.Sub].FooViewModel</c> maps to
    /// <c>Mfr.App.Ui.Views.FormatEditor.TokenEditors[.Sub].FooView</c>.
    /// </para>
    /// </summary>
    public sealed class FormatTokenEditorViewLocator : IDataTemplate
    {
        private const string ViewModelNamespacePrefix = "Mfr.App.Ui.ViewModels.FormatEditor.TokenEditors";
        private const string ViewNamespacePrefix = "Mfr.App.Ui.Views.FormatEditor.TokenEditors";

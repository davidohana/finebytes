...
namespace Mfr.App.Ui.Views.FileList
{
    ...
    public partial class FileListView : UserControl
    {
        ...
        private void _OnListingShortcutKeyDown(object? sender, KeyEventArgs e)
        {
            ...
            if (KeyGestureMatch.TryExecute(e, AppShortcuts.FileListCut, _viewModel.CutCommand))
            {
                return;
            }
            ...
            if (KeyGestureMatch.TryExecute(e, AppShortcuts.FileListDeletePermanent, _viewModel.DeletePermanentCommand))
            {
                return;
            }

            if (KeyGestureMatch.TryExecute(e, AppShortcuts.FileListDelete, _viewModel.DeleteCommand))
            {
                return;
            }
        ...
        private void _OnEntriesDoubleTapped(object? sender, TappedEventArgs e)
        {
            ...
            FileListDoubleClickAction.Execute(
                addsToRenameList: ConfigStore.Options.DoubleClickAddsToRenameList,

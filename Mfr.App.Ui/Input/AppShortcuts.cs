...
namespace Mfr.App.Ui.Input
{
    ...
    /// address Enter/Esc, Filter Chain Del/Ctrl+Arrow, Properties Alt+Enter, File List
    ...
    public static class AppShortcuts
    {
        ...
        /// <summary>Shows the OS property sheet for the focused File List or Rename List item.</summary>
        public static KeyGesture ShowProperties { get; } = new(Key.Enter, KeyModifiers.Alt);

        /// <summary>Cuts the File List selection to the Explorer file clipboard when the listing has focus.</summary>
        public static KeyGesture FileListCut { get; } = new(Key.X, KeyModifiers.Control);
        ...
        /// <summary>Permanently deletes the File List selection when the listing has focus.</summary>
        public static KeyGesture FileListDeletePermanent { get; } = new(Key.Delete, KeyModifiers.Shift);
        ...
        /// <summary>Removes selected Filter Chain when the list has focus.</summary>
        public static KeyGesture RemoveSelectedFilterDelete { get; } = RemoveSelectedDelete;

        /// <summary>Moves selected Filter Chain up when the list has focus.</summary>
        public static KeyGesture MoveFilterUp { get; } = MoveSelectedUp;

        /// <summary>Moves selected Filter Chain down when the list has focus.</summary>

...
- Filters: follow [.cursor/skills/mfr-implement-filter/SKILL.md](../mfr-implement-filter/SKILL.md).
...
- Prefer clean modern design over legacy shims (see `refactor-no-legacy-compat` rule); document intentional behavior changes in the brief.
